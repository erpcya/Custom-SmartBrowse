...
import org.adempiere.webui.component.GridTabRowRenderer.RowListener;
...
/*
	public void render(ListItem item, Object data) throws Exception {
		...
		wbListBox.getgFields().toArray(gridField);
...
//				}
	...
	*/
									  ...
									  int rowIndex, int columnIndex)
	{
		...
		GridField gfield = wbListBox.getgFields().get(columnIndex);
		if (gfield != null)
		{
			...
			if (gfield.getDisplayType() == DisplayType.YesNo)
			{
				...
				ZkCssHelper.appendStyle(listcell, "text-align:center");
						...
						|| gfield.getDisplayType() == DisplayType.Amount
							|| gfield.getDisplayType() == DisplayType.Integer)
			{
